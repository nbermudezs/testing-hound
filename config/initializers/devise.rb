...
Devise.setup do |config|
  ...
  config.secret_key = '056b2022919ace5aa6c2a8f2071c33f0f177ce2d5bf8ead5724fdd2a31261828356c1906e5b9d39f8838ac1c8aec08026f0ce4bdaf7237904ff9889b757b61be'
  ...
  # Configure parameters from the request object
  # used for authentication. Each entry
  ...
  # These keys will be downcased upon creating or
  ...
  # :database      = Support basic
  # authentication with authentication key + password
  ...
  # (e.g a value of 20 is already extremely
  # slow: approx. 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 10

  # Setup a pepper to generate the encrypted password.
  # config.pepper = 'c8d01a338bbf1d357cab8269502954f0de8eabb9a4
  # 128102b6d06b93a14e89a636651fd478ae443
  # 209d44f446fd8f60b09972f4267e8c739585b97649ce4e818'
  ...
  # You can use :sha1, :sha512 or encryptors from others
  # authentication tools as :clearance_sha1, :authlogic_sha512
